...
import { addRevisione } from "../../../api/revisioni";
...
export default function AggiungiRevisione() {
  const { id } = useParams();
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      toastSuccess("Revisione aggiunta con successo");
      allowLeaveAnd(goBack);
    } catch (err) {
      setSubmitError(err.message || "Errore durante il salvataggio");
      toastError("Errore nell'inserimento della revisione");
    } finally {
      setSaving(false);
    }
  }
  ...
  return (
    <PageScadenze>
      <div className="flex items-center gap-1 mb-2">
        ...
        <h2 className="font-bold text-text text-xl">Aggiungi revisione</h2>
      </div>
